                    ...
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                        ...
                        <ul class="addressFooter">
                            <li><i class="icon anm anm-map-marker-al"></i>
                                <p>Pontianak Barat,<br>Jl. apa adanya</p>
                            </li>
                            <li class="phone"><i class="icon anm anm-phone-s"></i>
                                <p>080000000</p>
                            </li>
                            <li class="email"><i class="icon anm anm-envelope-l"></i>
                                <p>arenasports.co.id</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <div class="row">
                    ...
                    <div
                        ...
                        <span></span> <a href="#">&copy; 2025 Arena Sports</a>
                    </div>
    ...
    <div id="popup-window">
        ...
        <div class="display-table splash-bg">
            <div class="display-table-cell width40"><img
                    src="{{ asset('template/assets/images/newsletter-img.jpg') }}" alt="Join Our Mailing List"
...
<!-- Including Jquery -->
<script src="{{ asset('template/assets/js/vendor/jquery-3.3.1.min.js') }}"></script>
<script src="{{ asset('template/assets/js/vendor/modernizr-3.6.0.min.js') }}"></script>
<script src="{{ asset('template/assets/js/vendor/jquery.cookie.js') }}"></script>
<script src="{{ asset('template/assets/js/vendor/wow.min.js') }}"></script>
<!-- Including Javascript -->
<script src="{{ asset('template/assets/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('template/assets/js/plugins.js') }}"></script>
<script src="{{ asset('template/assets/js/popper.min.js') }}"></script>
<script src="{{ asset('template/assets/js/lazysizes.js') }}"></script>
...
<script>
    function addToCart(productId) {
        fetch('/cart/add', {
            ...
            .then(data => {
                alert(data.message);
                location.reload(); // Reload cart di navbar
            });
    }
</script>

{{--  tambah keranjang lapangan --}}
<script>
    function addToCart1(productId) {
        fetch('/cartlapangan/add', {
                method: "POST",
                headers: {
                    "X-CSRF-TOKEN": "{{ csrf_token() }}",
                    "Content-Type": "application/json"
...
{{-- untuk hapus keranjang  setelah checkout  --}}
<script>
    document.addEventListener("DOMContentLoaded", function() {
        let cartCount = document.getElementById("CartCount").textContent;
        let checkoutButton = document.querySelector(".btn--small[href*='checkout']");

        if (parseInt(cartCount) === 0) {
            checkoutButton.classList.add("disabled");
            checkoutButton.style.pointerEvents = "none"; // Disable klik
        }
    });
</script>
