    ...
    <div class="collection-header">
        <div class="collection-hero">
            ...
            <div class="collection-hero__title-wrapper">
                <h1 class="collection-hero__title page-width">Semua produk Olahraga</h1>
            </div>
        </div>
    </div>
    <br><br>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-2 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <form class="variants add" action="{{ route('cart.add') }}" method="POST">
                                            ...
                                            <button class="btn btn-addto-cart" type="submit">Tambah Keranjang</button>
                                        </form>
                                        <div class="button-set">
                                            <a href="{{ route('belanja.show', $value->id) }}"
                                                title=" Cek detail {{ $value->nama }}"
