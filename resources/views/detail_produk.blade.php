                ...
                <div class="row">
                        ...
                        <div class="product-details-img">
                            <div class="product-thumb">
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    @php
                                        $gambarArray = is_array($produk->gambar)
                                            ? $produk->gambar
                                            : json_decode($produk->gambar, true);
                                    @endphp
                            ...
                            <div class="zoompro-wrap product-zoom-right pl-20">
                                <div class="zoompro-span">
                                    <img class="blur-up lazyload zoompro"
                                        data-zoom-image="{{ asset('storage/' . $produk->gambar) }}" alt=""
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-single__meta">
                            <h1 class="product-single__title">{{ $produk->nama }}</h1>
                            <div class="product-nav clearfix">
                                <a href="#" class="next" title="Next"><i class="fa fa-angle-right"
                                        aria-hidden="true"></i></a>
                            </div>
                            <div class="prInfoRow">
                                <div class="product-stock"> <span class="instock ">Stok : {{ $produk->stok }}</span> <span
                            ...
                            <p class="product-single__price product-single__price-product-template">
                                ...
                                <span
                                    ...
                                    <span id="ProductPrice-product-template"><span class="money">Rp.
                                        {{ number_format($produk->harga) }}</span></span>
                                </span>
                            </p>
                        </div>
                        <div class="product-single__description rte">
                            <p><strong>{{ strip_tags($produk->deskripsi) }}</strong></p>
                        </div>
