    ...
    <div id="MainContent" class="main-content" role="main">
        ...
        <div class="bredcrumbWrap">
            <div class="container breadcrumbs">
                <a href="/" title="Back to the home page">Beranda</a><span
                    aria-hidden="true">›</span><span>Detail {{ $lapangan->nama }}</span>
            </div>
        </div>
        <!--End Breadcrumb-->
        ...
        <div id="ProductSection-product-template" class="product-template__container prstyle1 container">
                ...
                <div class="row">
                        ...
                        <div class="product-details-img">
                            <div class="product-thumb">
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    @php
                                        $gambarArray = is_array($lapangan->gambar)
                                            ? $lapangan->gambar
                                            : json_decode($lapangan->gambar, true);
                                    @endphp

                                    @if (!empty($gambarArray) && is_array($gambarArray))
                                        @foreach ($gambarArray as $img)
                                            <a data-image="{{ asset('storage/' . $img) }}"
                                                data-zoom-image="{{ asset('storage/' . $img) }}" class="slick-slide">
                                                <img class="blur-up lazyload" data-src="{{ asset('storage/' . $img) }}"
                            ...
                            <div class="zoompro-wrap product-zoom-right pl-20">
                                <div class="zoompro-span">
                                    <img class="blur-up lazyload zoompro"
                                        data-zoom-image="{{ asset('storage/' . $lapangan->gambar) }}" alt=""
                            ...
                            <div class="lightboximages">
                                ...
                                @if (!empty($gambarArray))
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        <div class="zoompro-span">
                                            <img class="blur-up lazyload zoompro"
                                                data-zoom-image="{{ asset('storage/' . $gambarArray[0]) }}"
                                                alt="" src="{{ asset('storage/' . $gambarArray[0]) }}" />
                                        </div>
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-single__meta">
                            <h1 class="product-single__title">{{ $lapangan->nama }}</h1>
                            <div class="product-nav clearfix">
                                <a href="#" class="next" title="Next"><i class="fa fa-angle-right"
                                        aria-hidden="true"></i></a>
                            </div>
                            <div class="prInfoRow">
                                <div class="product-stock"> <span class="instock ">Stok : {{ $lapangan->stok }}</span>
                            ...
                            <p class="product-single__price product-single__price-product-template">
                                ...
                                <span
                                    ...
                                    <span id="ProductPrice-product-template"><span class="money">Rp.
                                            {{ number_format($lapangan->harga) }}</span></span>
                                </span>
                            </p>
                            <p><strong>Fasilitas:</strong>
                                @php
                                    $fasilitasArray = is_array($lapangan->fasilitas)
                                        ? $lapangan->fasilitas
                        ...
                        <div class="product-single__description rte">
                            <p><strong>{{ strip_tags($lapangan->deskripsi) }}</strong></p>
                        </div>
            ...
            <div class="related-product grid-products">
                <header class="section-header">
                    ...
                    <p class="sub-heading">You can manage this section from store admin as describe in above section
                    </p>
                </header>
                <div class="productPageSlider">
                    <div class="col-12 item">
