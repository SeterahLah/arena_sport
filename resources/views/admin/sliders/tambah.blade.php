                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="deskripsi_singkat" id="deskripsi_singkat"
                                                        class="form-control" value="{{ old('deskripsi_singkat') }}"
                                                        required>
                                                </div>
                                                <div class="mb-3">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="pilihan" id="pilihan" class="form-select" required>
                                                        <option value="-"
                                                            {{ old('pilihan') == 'Belanja Sekarang' ? 'selected' : '' }}>
                                                            ---------------------- Pilih Aksi ----------------------
                                                        </option>
                                                        ...
                                                        <option value="Booking Sekarang"
                                                            {{ old('pilihan') == 'Booking Sekarang' ? 'selected' : '' }}>
                                                            Booking Sekarang</option>
                                                        <option value="Kunjungi Sekarang"
                                                            {{ old('pilihan') == 'Kunjungi Sekarang' ? 'selected' : '' }}>
