                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="deskripsi" id="summernote" class="form-control" value="{{ old('deskripsi') }}" required></textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="alamat" class="form-label">Alamat</label>
                                                    <input name="alamat" id="alamat" class="form-control" value="{{ old('alamat') }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="url" class="form-label">Url Tujuan</label>
                                                    <input name="url" id="url" class="form-control" value="{{ old('url') }}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="by" id="by" class="form-control" value="{{ old('by') }}" required>
                                                </div>
                                                <div>
